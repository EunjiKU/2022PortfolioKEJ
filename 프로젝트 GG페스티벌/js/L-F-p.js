$(function (){
  ...
  $("#password2_box .input").keydown(function(){
    //전화번호
    var password2 = $("input[name='password2']").val();
    if(!(password2.length == 4)){
        $("#password2").addClass("error").removeClass("pass");
        $("#password2_box i").addClass("error").removeClass("pass");
    }else{
      $("#password2").addClass("pass").removeClass("error");
      $("#password2_box i").addClass("pass").removeClass("error");
    }
  })
